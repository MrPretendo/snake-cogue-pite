...
const ES = {
  ...
  'menu.ranking': 'RANKING', 'rank.titulo': 'RANKING', 'rank.cargando': 'Cargando…', 'rank.vacio': 'Todavía no hay puntuaciones. ¡Sé el primero!',
...
const EN = {
  ...
  'menu.ranking': 'LEADERBOARD', 'rank.titulo': 'LEADERBOARD', 'rank.cargando': 'Loading…', 'rank.vacio': 'No scores yet. Be the first!',
