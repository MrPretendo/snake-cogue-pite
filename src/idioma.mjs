...
// Sin persistencia: ingles por defecto, se cambia con L.

export const IDIOMAS = ['es', 'en'];

// Ingles por defecto; L o el boton ES·EN cambian.
let actual = 'en';
...
const ES = {
  ...
  // subida de nivel
  'nivel.titulo': '¡MUTACIÓN DESBLOQUEADA!', 'nivel.sub': 'Elige una mejora:', 'nivel.mejora': 'Nvl {n} (Mejora)',
  // menú
  ...
  'sel.atras': 'ATRÁS', 'rank.titulo': 'TOP 10', 'rank.cargando': 'Cargando…', 'rank.vacio': 'Sin puntuaciones todavía.',
  'rank.sinConexion': 'Sin conexión con el ranking.', 'rank.nombre': 'Nombre', 'rank.enviar': 'ENVIAR', 'rank.enviado': 'Enviado.',
  'rank.error': 'No se pudo enviar.', 'rank.nombreVacio': 'Falta el nombre.', 'rank.pts': 'pts',
  ...
  'ctl.cola': 'Cruzar la cola', 'ctl.colaD': 'Salto con coste de energía',
  'ctl.sinEnergia': 'Sin energía', 'ctl.sinEnergiaD': 'La cola se quema; cuanto más larga llegó a ser, más rápido. Al acabarse, muerte. Desde ×3, sin margen.',
  'ctl.apuesta': 'LA APUESTA', 'ctl.racha': 'Racha', 'ctl.rachaD': 'Frutas encadenadas suben el multiplicador; sin fruta a tiempo, se rompe.',
  'ctl.bote': 'Bote', 'ctl.boteD': 'Lo que entra con racha y apalancamiento. Se pierde al morir.',
  'ctl.cobrarD': 'Cobrar el bote (×1).',
  'ctl.apalancD': 'Apalancamiento ×1 a ×5: multiplica bote, gasto y coste del salto; algo más de velocidad. Desde ×3, sin energía = liquidación. Bajar quema el 25 % del bote.',
  'ctl.fichasD': 'Tres frutas doradas = una tirada. Pareja: mejora 9 s. Triple: mejora y bote ×3.',
  'ctl.sonidoD': 'Sonido.', 'ctl.idiomaD': 'Idioma.',
  // tragaperras
  ...
  'sel.titulo': 'MECÁNICA SUPERIOR', 'sel.sub': 'Una regla para toda la run.', 'sel.clasica': 'Clásica', 'sel.clasicaD': 'Sin reglas extra.',
  'sel.bote': '{n} · Bote x{m}', 'sel.rebobinar': 'REBOBINAR', 'sel.elegida': '{nombre} · BOTE x{m}',
  // fin de run
  'fin.titulo': 'FIN DE LA RUN', 'fin.puntos': 'PUNTOS', 'fin.rango': 'Rango: {r}', 'fin.colaMax': 'Cola máxima', 'fin.casillas': '{n} casillas',
...
const EN = {
  ...
  'nivel.titulo': 'MUTATION UNLOCKED!', 'nivel.sub': 'Choose an upgrade:', 'nivel.mejora': 'Lv {n} (Upgrade)',
  ...
  'sel.atras': 'BACK', 'rank.titulo': 'TOP 10', 'rank.cargando': 'Loading…', 'rank.vacio': 'No scores yet.',
  'rank.sinConexion': 'No connection to the leaderboard.', 'rank.nombre': 'Name', 'rank.enviar': 'SUBMIT', 'rank.enviado': 'Sent.',
  'rank.error': 'Could not send.', 'rank.nombreVacio': 'Name missing.', 'rank.pts': 'pts',
  ...
  'ctl.cola': 'Cross the tail', 'ctl.colaD': 'Jump, costs energy',
  'ctl.sinEnergia': 'Out of energy', 'ctl.sinEnergiaD': 'The tail burns; the longer it ever got, the faster. When it runs out, death. From ×3, no margin.',
  'ctl.apuesta': 'THE BET', 'ctl.racha': 'Streak', 'ctl.rachaD': 'Chained fruits raise the multiplier; no fruit in time breaks it.',
  'ctl.bote': 'Pot', 'ctl.boteD': 'What streak and leverage bring in. Lost on death.',
  'ctl.cobrarD': 'Cash the pot (×1).',
  'ctl.apalancD': 'Leverage ×1 to ×5: multiplies pot, drain and jump cost; a bit more speed. From ×3, no energy = liquidation. Lowering burns 25% of the pot.',
  'ctl.fichasD': 'Three golden fruits = one spin. Pair: 9 s boost. Triple: boost and pot ×3.',
  'ctl.sonidoD': 'Sound.', 'ctl.idiomaD': 'Language.',
  ...
  'sel.titulo': 'HIGHER MECHANIC', 'sel.sub': 'One rule for the whole run.', 'sel.clasica': 'Classic', 'sel.clasicaD': 'No extra rules.',
  'sel.bote': '{n} · Pot x{m}', 'sel.rebobinar': 'REROLL', 'sel.elegida': '{nombre} · POT x{m}',
  'fin.titulo': 'RUN OVER', 'fin.puntos': 'POINTS', 'fin.rango': 'Rank: {r}', 'fin.colaMax': 'Max tail', 'fin.casillas': '{n} tiles',
  ...
  'ctl.artefactos': 'Artifacts', 'ctl.artefactosD': 'On the arena for 15 s: portal (A ↔ B), boost (5 s of speed, no drain), sweep (pulls and doubles fruits), euphoria (instant frenzy).',
  ...
  'mec.cola.name': 'Untouchable Tail', 'mec.cola.desc': 'Touching the tail ends the run.',
  ...
  'sym.escudo.name': 'INVINCIBLE', 'sym.escudo.desc': 'immune; the tail crosses free',
  'sym.energia.name': 'NO DRAIN', 'sym.energia.desc': 'energy does not drop',
  'sym.iman.name': 'TOTAL MAGNET', 'sym.iman.desc': 'pulls every fruit on the arena',
